...
import { fetchPullRequests, parseGitHubUrl } from '@/lib/services/githubService';
...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const { data, error } = await fetchPullRequests(owner, repo, project.github_pat_encrypted, {
      state,
