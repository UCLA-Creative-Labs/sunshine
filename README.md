...
[mergify-status]: https://img.shields.io/endpoint.svg?url=https://gh.mergify.io/badges/UCLA-Creative-Labs/sunshine&style=flat

A place full of cool stuff, things, and peeps. `Sunshine` is the tech behind our website: where the funkiest stuff in design and tech happen!
...
Thanks for your interest in contributing to `Sunshine`! ❤️
...
5. Stage, commit, and push your changes to make a [pull request](https://github.com/UCLA-Creative-Labs/sunshine/pulls)!
